import 'package:school_app/modules/employee/employ_hp_screen/controller/employ_home_controller.dart';
                      ...
                      child: Row(
                          ...
                          children: [
                            Padding(
                                ...
                                child: GetBuilder<EmployHomeController>(
                                    builder: (_) {
                                  return Text(
                                      "lbl_attendence".tr +
                                          "  (${_.selectedDate.day}"
                                              " ${Jiffy.parse(_.selectedDate.toIso8601String()).MMMM})",
